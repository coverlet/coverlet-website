  ...
  return (
    <div className="passing-text container">
      ...
      >
        ...
        <span className="subtext">We operate validators on these projects. Token holders can stake with us to help secure these networks and earn staking rewards. Join the staking ecosystem today with coverlet.</span>
      </div>
    </div>
  );
};
